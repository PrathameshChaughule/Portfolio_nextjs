        ...
        <div id='contact' className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[length: 90%_auto]'>
            ...
            <form action="" className='max-w-2xl mx-auto'>
                <div className='grid grid-cols-auto gap-6 mt-10 mb-8'>
                    <input type="text" className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white' placeholder='Enter your name' required name="" id="" />
                    <input type="email" className='flex-1 p-3 outline-none border-[0.5px] border-gray-400 rounded-md bg-white' placeholder='Enter your email' required name="" id="" />
                </div>
                <textarea rows='6' className='flex-1 p-4 outline-none border-[0.5px] border-gray-400 rounded-md bg-white mb-6' placeholder='Enter your message' required name="" id=""></textarea>
